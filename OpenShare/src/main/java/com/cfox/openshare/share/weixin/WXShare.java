package com.cfox.openshare.share.weixin;
 ...
 * <br/>PACKAGE_NAME : com.cfox.openshare.share.weixin
 * <br/>AUTHOR : Machao
 * <br/>MSG :
 * <br/>************************************************
 */
public class WXShare implements IShare {
    ...
    private void shareMusic(Bitmap thumBmp, ShareAPI shareAPI) {
        ...
        musicObject.musicUrl = shareAPI.getShareMedia().getMediaUrl();
    ...
    private void shareVideo(Bitmap thumBmp, ShareAPI shareAPI) {
        ...
        videoObject.videoUrl = shareAPI.getShareMedia().getMediaUrl();
